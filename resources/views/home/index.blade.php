<x-guest-layout>
    ...
    <section id="home" class="relative overflow-hidden pt-28 lg:pt-32 pb-20 px-4 hero-bg hero-grid-bg">
        ...
        <div class="max-w-5xl lg:max-w-7xl mx-auto">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="animate-slide-up">
                    ...
                    <h1
                        class="text-4xl sm:text-5xl lg:text-6xl font-display font-bold mb-6 leading-tight lg:leading-[1.1]">
                        Empowering <span class="text-gradient">Digital Transformation</span> through<span
                            class="text-gradient"> Intelligent Software.</span>
                    </h1>


                    <p class="text-lg sm:text-xl text-gray-400 mb-8 leading-relaxed">
                        At TechTower Inc, We engineer high-performance applications and scalable platforms to transform
                        how businesses operate, innovate, and thrive in the digital landscape.
                    </p>

                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="#services"
                            class="btn-primary rounded-xl text-center flex items-center justify-center space-x-2">
                    ...
                    <!-- Stats -->
                    <div class="grid grid-cols-3 gap-5 mt-12" x-data="counterStats()" x-ref="statsContainer">
                        <div>
                            <div class="text-3xl sm:text-4xl font-display font-bold text-gradient"
                                x-text="projectsCount + '+'"></div>
                            <div class="text-sm text-gray-400 mt-1">Projects Delivered</div>
                        </div>
                        <div>
                            <div class="text-3xl sm:text-4xl font-display font-bold text-gradient"
                                x-text="satisfactionCount + '%'"></div>
                            ...
                            <template x-for="(item, index) in items" :key="index">
                                <div x-show="current === index" x-transition:enter="transition ease-out duration-500"
                                    ...
                                    <div class="absolute bottom-0 left-0 right-0 p-8">
                                        <div class="inline-block glass px-3 py-1 rounded-full text-xs font-bold mb-3"
                            ...
                            <div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex space-x-2 z-10">
                                <template x-for="(item, index) in items" :key="index">
                                    <button @click="current = index"
                                        ...
                                        :class="current === index ? 'bg-[--primary] w-8' : 'bg-white/30 hover:bg-white/50'"></button>
                                </template>
                            </div>
                        </div>
                    </div>
    ...
    <section id="services" class="py-20 px-4">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center" x-data="{ showAll: false }">
                <button class="btn-glass rounded-xl">VIEW MORE SERVICES</button>
            </div>
        </div>
    </section>
                    ...
                    <div class="glass-hover rounded-3xl overflow-hidden card-product group cursor-pointer"
                        ...
                        <div class="relative aspect-[4/3]">
                            ...
                            <div class="absolute top-4 right-4">
                                <button
                                    class="w-10 h-10 rounded-full glass flex items-center justify-center hover:bg-white/20 transition">
    ...
    <section id="shop" class="py-20 px-4">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                <span class="glass px-4 py-2 rounded-full text-sm font-display tracking-wider inline-block mb-4">TECH
                    STORE</span>
                <h2 class="text-4xl sm:text-5xl lg:text-6xl font-display font-bold mb-6">
                    Shop <span class="text-gradient">Our Products</span>
                </h2>
                <p class="text-gray-400 max-w-2xl mx-auto">Premium development tools, templates, and resources for
                    modern developers</p>
            </div>
                ...
                <template x-for="product in featuredProducts" :key="product.id">
                    <div class="glass-hover rounded-3xl overflow-hidden card-product">
                        <div class="relative aspect-square">
                            ...
                            <span class="badge" :class="product.badge === 'NEW' ? 'badge-new' : 'badge-sale'"
                            ...
                            <button @click="toggleWishlist(product.id)"
                                ...
                                <i
                                    :class="isInWishlist(product.id) ? 'fas fa-heart text-red-500' : 'far fa-heart text-white'"></i>
                            </button>
                        </div>
                        <div class="p-6">
                            ...
                            <div class="flex items-center space-x-2 mb-4">
                                ...
                                <span x-show="product.oldPrice" class="text-sm text-gray-500 line-through"
                                    x-text="product.oldPrice ? '$' + product.oldPrice : ''"></span>
                            </div>
                            <button @click="addToCart(product)"
                                class="w-full btn-primary rounded-xl flex items-center justify-center space-x-2">
